...
abstract class Styles
{
  ...
  static final styleOfFontTextFormFieldBlack16 = TextStyle(color: black, fontWeight: FontWeight.w500, fontSize: 16.sp);
  ...
  static BorderRadius roundedCornersOfBottomSheet = const BorderRadius.vertical(top: Radius.circular(25));
  static OutlineInputBorder styleOfCartTextFormField() => OutlineInputBorder(borderRadius: BorderRadius.circular(25), borderSide: const BorderSide(color: lightBlue, width: 3.5));
}