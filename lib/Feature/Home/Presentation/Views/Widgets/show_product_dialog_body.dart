      ...
      child: Column(
        ...
        children: [
          productModel.imagesUrls.length == 1 ? Padding(
            ...
            child: CustomProductSingleImage(productModel: productModel, height: 350, width: double.infinity),
          ...
          Text(productModel.productName, style: TextStyle(color: black, fontWeight: FontWeight.w600, fontSize: 16.sp), textAlign: TextAlign.center),
